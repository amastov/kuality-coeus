class SupplementalInfo < BasePage
  ...
  element(:billing_element) { |b| b.text_field(name: 'document.customDataList[2].value') }
  element(:graduate_student_count) { |b| b.text_field(name: 'document.customDataList[6].value') }
